...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("object", 1, "circle")
        self.add_class("object", 2, "non-circle")
        ...
        annotations1 = json.load(open(os.path.join(dataset_dir, "pipes.json")))
        # print(annotations1)
        ...
        for a in annotations:
            ...
            objects = [s['region_attributes']['Pipes'] for s in a['regions']]

            #print("objects:",objects)
           
            name_dict = {"circle": 1,"no-circle": 2}
            # key = tuple(name_dict)
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        ply_G= info['shapes'] #new
        
        label_names= [i['name'] for i in ply_G] #new
        
        mask_names= ['circle', 'no-circle'] #new
        
        dims = len(info["shapes"])
        ...
        for i, p in enumerate(info["shapes"]):
            ...
            #else:
            #    raise Exception('Unknown annotation type. Supported annotation types: Polygon, Circle, Ellipse.')
    ...
    def draw_mask(self, image, poly, label_name):
        ...
        if label_name in ['polygon', 'circle', 'ellipse']:
...
def train(model):
    ...
    dataset_train.load_custom("C:/...../project/pipes/datasets", "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("C:/...../project/pipes/datasets", "val")
    dataset_val.prepare()
